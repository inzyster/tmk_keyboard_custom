...
#define KEYMAP_TKG( \
    ...
    { KC_##K5A, KC_##K5B, KC_##K5C, KC_NO,    KC_NO,    KC_##K5F, KC_##K5G, KC_NO,    KC_##K5I, KC_NO,    KC_##K5K, KC_##K5L, KC_##K5M, KC_##K5N, KC_##K5O }  \
}
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP_TKG(
        ...
        CAPS,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,BSLS,ENT, PGDN, \
    ...
    [1] = KEYMAP_TKG(
        ...
        TRNS,FN1, FN2, FN3, FN4, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     VOLU, \
